...
void EffPurFromHistos2D::compute (DQMStore::IBooker & ibook)
{
  ...
  DUSG_reject_vs_B_reject_at_cEff->getTH2D()->SetXTitle ( "B Rejection" );
  DUSG_reject_vs_B_reject_at_cEff->getTH2D()->SetYTitle ( "Light Rejection" );
  DUSG_reject_vs_B_reject_at_cEff->getTH2D()->GetXaxis()->SetTitleOffset ( 0.75 );
  DUSG_reject_vs_B_reject_at_cEff->getTH2D()->GetYaxis()->SetTitleOffset ( 0.75 );
